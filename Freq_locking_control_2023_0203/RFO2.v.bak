...
wire signed [13:0] inj,injection;
assign inj={{5{r}},1'b1,8'b0};
...
assign e4= {{10{y}},1'b1,6'b0}-g256[22:6]+{{3{injection[13]}},injection};  // r=injection, y=relay_feedback, r:y=1:1
...
wire signed [17:0] f32,f128;//,f64;
assign f128={{1{y}},f8192[22: 6]};
assign f32={{3{y}},f8192[22: 8]};
//assign f64={{2{y}},f8192[22: 7]};//+  //{{2{y}},f8192[22: 8]}+{{3{y}},f8192[22:9]}+
           //+{{6{y}},f8192[22:12]};                      //{{5{y}},f8192[22:11]}+{{6{y}},f8192[22:12]};

wire signed [17:0] f0d5,f1,f2,f4,f8,f16; //f0d125,//f0d25,f0d5,
//assign f0d25={{10{y}},f8192[22:15]};
assign f0d5={{9{y}},f8192[22:14]}; 
//assign f0d125={{11{y}},f8192[22:16]}; 
...
wire signed [17:0] fk;
assign fk=f1+f2+f4+f8+f16+f32+f128+f0d5;//20.1kHz   //f0d125//-f0d25;//f0d5+
